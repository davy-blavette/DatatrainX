    ...
    <div class="tile is-parent">
        <div class="tile is-child">
            ...
            <article class="content">
                ...
                <p>Pour ce faire, nous utiliserons des algorithmes de deep-Learning et plus particulièrement les réseaux de neurones convolutifs (CNN) dans la reconnaissance des émotions de bases définies par le psychologue P. Ekman ('Colère', 'Dégoût', 'Peur', 'Joie', 'Triste', 'Surprise', 'Neutre').</p>
                ...
                <div class="buttons center">
                    <button class="button is-primary" id="explain-button" on:click={() => animateScroll.scrollTo({element: "#header", onDone: (element, offset) => {layoutStore.setLayout("resultatKolb")}}) }>
                            <span class="icon">
                              <i class="fas fa-eye"></i>
                            </span>
                        <span>Exemple de résultats d'un test</span>
                    </button>
                </div>
