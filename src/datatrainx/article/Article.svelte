    ...
    <div class="tile is-parent">
        <div class="tile is-child">
            ...
            <article class="content">
                ...
                <p>Pour ce faire, nous utiliserons des algorithmes de deep-Learning et plus particulièrement les réseaux de neurones convolutifs (CNN) dans la reconnaissance des émotions de bases défini par le psychologue P. Ekman ('Colère', 'Dégoût', 'Peur', 'Joie', 'Triste', 'Surprise', 'Neutre').</p>
